...
class Config:
    def __init__(self):
        try:
            ...
            self.FFMPEG = config(
                "FFMPEG",
                default='ab-av1 auto-encode -i "{}" --svt tune=2 --keyint 321 --max-crf 63 --min-vmaf 79 --preset 9 --vfilter scale=1280:-2:flags=bicubic:param0=0:param1=1/2 -o "{}"',
            )
            ...
            self.MUX_ARGS = config(
                "MUX_ARGS", default="-c:v copy -c:a libopus -b:a 32k -ac 2"
            )
